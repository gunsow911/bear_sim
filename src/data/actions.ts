...
export const ACTIONS: Record<ActionKind, ActionDef> = {
  mowing: {
    ...
    effectLabel: 'しばらくの間、この地区への流入を抑える',
    realTerms: ['緩衝帯整備'],
    realWorldDesc:
      '集落と山林の境界に茂った藪を刈り払い、見通しをよくする緩衝帯整備です。クマが身を隠して里へ下りる“けものみち”を断ち、人里に近づきにくくします。',
  },
  'electric-fence': {
    kind: 'electric-fence',
    name: '電気柵の設置',
    ...
    effectLabel: 'しばらくの間、里山の出没を1回だけ防ぐ',
    realTerms: ['侵入防止柵'],
    realWorldDesc:
      '農地や養蜂場のまわりに電気柵（侵入防止柵）を張りめぐらせ、クマの侵入を物理的に防ぐ被害防止対策です。除去しきれない誘引物を守るのに使われます。',
  },
  'attractant-removal': {
    ...
    effectLabel: 'この地区の里山・市街の出没率をしばらく抑え続ける',
    realTerms: ['誘引物除去'],
    realWorldDesc:
      '放置された柿や栗、屋外の生ゴミなど、クマを人里へ引き寄せる誘引物を地域ぐるみで取り除く誘引物除去です。',
  },
  patrol: {
    kind: 'patrol',
    name: 'パトロール',
    ...
    realTerms: ['クマレンジャー'],
    realWorldDesc:
      'クマレンジャーや鳥獣専門指導員が地区を巡回し、早期発見・現場対応・住民への助言にあたります。',
  },
  hazing: {
    kind: 'hazing',
    name: '追い払い',
    ...
    effectLabel: 'この地区の出没を今すぐ抑える（繰り返すと慣れて効かなくなる）',
    realTerms: ['追い払い'],
    realWorldDesc:
      '花火・犬・爆音機などでクマを山へ追い返す追い払いです。すぐ効きますが、同じ手を繰り返すとクマが慣れてしまい、だんだん通用しなくなります。',
  },
  'box-trap': {
    kind: 'box-trap',
    name: '箱わなによる捕獲',
    ...
    flavor:
      '排除地域に箱わなを仕掛け、里へ通う個体を待ち受けます。かかれば人里に出る前に捕らえられ、以後その地区に降りてくる圧そのものが和らぎます。',
    effectLabel: 'この地区に来た個体を捕らえ、以後の里山の出没率上昇を和らげる',
    realTerms: ['個体数管理'],
    realWorldDesc:
      '排除地域に箱わなを設置し、里に通う個体を捕獲する個体数管理の手法です。個体群を守るため、年間の捕獲上限のもとで慎重に運用されます。',
  },
  'emergency-shooting': {
    ...
    instructionPointCost: 2,
    flavor:
      '市街地に居座る個体へ、市町の判断で緊急の銃猟を実施します。市街の危険を即座に断ち切りますが、発砲は住民を動揺させ、事故の恐れもあります。',
    effectLabel: '市街に出た個体を緊急排除する（住民は動揺する）',
    realTerms: ['緊急銃猟'],
    realWorldDesc:
      '市街地などでクマが人に緊急の危険を及ぼす際、市町村の判断で銃猟を実施できる緊急銃猟の制度です。',
  },
}
